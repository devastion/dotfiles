...
function artisan() {
  ...
  local docker_compose_config_path=$(find $laravel_path -maxdepth 1 \( -name "compose.yaml" -o -name "compose.yml" -o -name "docker-compose.yaml" -o -name "docker-compose.yml" \) | head -n1)
  local artisan_cmd
