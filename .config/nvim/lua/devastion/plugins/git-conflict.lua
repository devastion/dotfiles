...
vim.keymap.set("n", "<leader>gxn", function() require("git-conflict").find_next("ours") end, { desc = "Next Conflict" })
vim.keymap.set("n", "<leader>gxp", function() require("git-conflict").find_prev("ours") end, { desc = "Prev Conflict" })
vim.keymap.set("n", "<leader>gxo", function() require("git-conflict").choose("ours") end, { desc = "Choose Ours" })
vim.keymap.set("n", "<leader>gxt", function() require("git-conflict").choose("theirs") end, { desc = "Choose Theirs" })
